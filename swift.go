...
// are already set.  It returns the modified Connection passed in for
// ease of use.
//
...
//     GOSWIFT_CONNECT_TIMEOUT - Connect channel timeout in seconds (default 10)
//     GOSWIFT_TIMEOUT - Data channel timeout in seconds (default 60)
//     GOSWIFT_INTERNAL - Set this to 1 to use the the internal network (obsolete - use OS_ENDPOINT_TYPE)
